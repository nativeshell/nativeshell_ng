...
// static
void FlutterEngineContextPlugin::RegisterWithRegistrar(
  ...
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "dev.nativeshell.flutter_engine_context",
          &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<FlutterEngineContextPlugin>(handle);
