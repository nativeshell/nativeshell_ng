...
public class FlutterEngineContextPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  static public Activity getActivity(int handle) {
    final FlutterEngineContextPlugin plugin = registry.getPlugin(handle);
  ...
  static class Registry {
    int registerPlugin(FlutterEngineContextPlugin plugin) {
    ...
    FlutterEngineContextPlugin getPlugin(int handle) {
    ...
    private final Map<Integer, FlutterEngineContextPlugin> plugins = new HashMap<>();
